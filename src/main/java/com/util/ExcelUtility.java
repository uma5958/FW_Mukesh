...
public class ExcelUtility {
	...
	public void setCellData(String sheetName, int colNum, int rowNum, String data) {
		try {
			...
			int index = workbook.getSheetIndex(sheetName);
			sheet = workbook.getSheetAt(index);
			sheet.getRow(rowNum-1).createCell(colNum).setCellValue(data);
	...
	// Get data from a given cell, generate random data and write it to the same cell
	public String getRandomData(String sheetName, int colNum, int rowNum) {
		ExcelUtility reader = new ExcelUtility(path);
		String newData = null;
		String old = reader.getCellData(sheetName, colNum, rowNum);
		...
		reader.setCellData(sheetName, colNum, rowNum, newData);
		return newData;
	}

	public String getOrderedRandomData(String sheetName, int colNum, int rowNum) {
		ExcelUtility reader = new ExcelUtility(path);
		String oldData = reader.getCellData(sheetName, colNum, rowNum);
